...
package com.shatteredpixel.reassembledpixeldungeon.actors;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Charm;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Chill;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Cripple;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.EarthImbue;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.FireImbue;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Speed;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Thorns;
...
public abstract class Char extends Actor {
	...
	public void damage( int dmg, Object src ) {
		...
		if (this.buff(Thorns.class) != null){
			if (src instanceof Char){
				((Char) src).damage(Random.IntRange(0,((int)(.5*dmg))), this);
			}
		}
