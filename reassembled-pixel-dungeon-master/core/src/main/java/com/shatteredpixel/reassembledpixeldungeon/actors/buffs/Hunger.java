...
public class Hunger extends Buff implements Hero.Doom {
	...
	public void reduceHunger( float energy ) {
		...
		Dungeon.hunger -= energy;
		if (Dungeon.hunger < 0) {
			Dungeon.hunger = 0;
		} else if (Dungeon.hunger > STARVING) {
			Dungeon.hunger = STARVING;
		}
	...
	public boolean isStarving() {
		return Dungeon.hunger >= STARVING;
	}

	public int hunger() {
		return (int)Math.ceil(Dungeon.hunger);
	}

	@Override
	public int icon() {
		if (Dungeon.hunger < HUNGRY) {
