...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Corruption;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.SoulMark;
...
import com.shatteredpixel.reassembledpixeldungeon.effects.Surprise;
...
import com.shatteredpixel.reassembledpixeldungeon.levels.Level.Feeling;
...
public abstract class Mob extends Char {
	...
	protected boolean getCloser( int target ) {
		...
		if (step != -1) {
			if (armor != null && armor.hasGlyph(Stone.class) &&
