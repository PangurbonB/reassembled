...
package com.shatteredpixel.reassembledpixeldungeon.items.food;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.ToxicImbue;
...
import com.shatteredpixel.reassembledpixeldungeon.plants.Plant.Seed;
...
public class Blandfruit extends Food {
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals( AC_EAT ) && potionAttrib != null){
			...
			} else if (potionAttrib instanceof PotionOfOoze) {
				GLog.i(Messages.get(this, "thorn_msg"));
				Buff.affect(hero, Thorns.class, EarthImbue.DURATION);
			}else {
	...
	public Item imbuePotion(Potion potion){
		...
		if (potionAttrib instanceof PotionOfHealing){
			...
			name = Messages.get(this, "oozefruit");
			potionGlow = new ItemSprite.Glowing( 0xAB70CF );
		}
