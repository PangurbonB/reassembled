...
package com.shatteredpixel.reassembledpixeldungeon.items.weapon;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.hero.HeroClass;
...
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Annoying;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Displacing;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Exhausting;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Fragile;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Sacrificial;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.curses.Wayward;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Blazing;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Chilling;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Dazzling;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Eldritch;
...
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Lucky;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Projecting;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Shocking;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Stunning;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Unstable;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Vampiric;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Venomous;
import com.shatteredpixel.reassembledpixeldungeon.items.weapon.enchantments.Vorpal;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public static abstract class Enchantment implements Bundlable {
		...
		public static final Class<?>[] enchants = new Class<?>[]{
			...
			Grim.class, Stunning.class, Vampiric.class, Ethereal.class,};
		public static final float[] chances= new float[]{
			10, 10, 10, 10,
			5, 5, 5, 5, 5, 5,
			2, 2, 2, 2 };
