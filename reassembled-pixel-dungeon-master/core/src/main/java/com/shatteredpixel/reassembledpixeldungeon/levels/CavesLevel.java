...
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.ConfusionTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.ExplosiveTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.FireTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.FlashingTrap;
...
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.ParalyticTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.PitfallTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.PoisonTrap;
...
public class CavesLevel extends RegularLevel {
	...
	protected Class<?>[] trapClasses() {
		return new Class[]{ FireTrap.class, FrostTrap.class, PoisonTrap.class, SpearTrap.class, VenomTrap.class, GoldSpearTrap.class, SlowTrap.class,
				ExplosiveTrap.class, FlashingTrap.class, GrippingTrap.class, ParalyticTrap.class, LightningTrap.class, RockfallTrap.class, OozeTrap.class, SlowTrap.class,
				ConfusionTrap.class, FlockTrap.class, GuardianTrap.class, PitfallTrap.class, SummoningTrap.class, TeleportationTrap.class, BeeTrap.class,
				WarpingTrap.class, FloodTrap.class};
	}

	@Override
	protected float[] trapChances() {
		return new float[]{ 8, 8, 8, 8, 8, 8, 8,
				4, 4, 4, 4, 4, 4, 4, 4,
				2, 2, 2, 2, 2, 2, 2,
				1, (float).2 };
	}
