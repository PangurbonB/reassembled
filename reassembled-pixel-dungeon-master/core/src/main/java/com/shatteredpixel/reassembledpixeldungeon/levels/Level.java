...
import com.shatteredpixel.reassembledpixeldungeon.actors.blobs.Alchemy;
import com.shatteredpixel.reassembledpixeldungeon.actors.blobs.Blob;
import com.shatteredpixel.reassembledpixeldungeon.actors.blobs.WellWater;
...
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.LockedFloor;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.MindVision;
import com.shatteredpixel.reassembledpixeldungeon.actors.buffs.Shadows;
...
import com.shatteredpixel.reassembledpixeldungeon.effects.particles.FlowParticle;
import com.shatteredpixel.reassembledpixeldungeon.effects.particles.WindParticle;
...
import com.shatteredpixel.reassembledpixeldungeon.items.Torch;
...
import com.shatteredpixel.reassembledpixeldungeon.levels.features.Door;
import com.shatteredpixel.reassembledpixeldungeon.levels.features.HighGrass;
...
import com.shatteredpixel.reassembledpixeldungeon.mechanics.ShadowCaster;
...
public abstract class Level implements Bundlable {
	...
	public static boolean[] meltable;
	...
	protected void buildFlagMaps() {
		...
		for (int i=0; i < length(); i++) {
			...
			meltable[i]		= (flags & Terrain.MELTABLE) != 0;
		}
	...
	public static void set( int cell, int terrain ) {
		...
		meltable[cell]		= (flags & Terrain.MELTABLE) != 0;
	...
	public String tileName( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.BARS:
				return Messages.get(Level.class, "bars_name");
			case Terrain.HIGH_GRASS:
	...
	public String tileDesc( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.BARS:
				return Messages.get(Level.class, "bars_desc");
			case Terrain.SIGN:
