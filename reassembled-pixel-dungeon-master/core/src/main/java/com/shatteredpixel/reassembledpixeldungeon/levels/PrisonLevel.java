...
import com.shatteredpixel.reassembledpixeldungeon.effects.Halo;
...
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.AlarmTrap;
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.ChillingTrap;
...
import com.shatteredpixel.reassembledpixeldungeon.levels.traps.ToxicTrap;
...
public class PrisonLevel extends RegularLevel {
	...
	protected Class<?>[] trapClasses() {
		return new Class[]{ ChillingTrap.class, FireTrap.class, PoisonTrap.class, SpearTrap.class, ToxicTrap.class,
				AlarmTrap.class, FlashingTrap.class, GrippingTrap.class, ParalyticTrap.class, LightningTrap.class, OozeTrap.class, SlowTrap.class, BeeTrap.class,
				ConfusionTrap.class, FlockTrap.class, SummoningTrap.class, TeleportationTrap.class, GoldSpearTrap.class, };
	}
