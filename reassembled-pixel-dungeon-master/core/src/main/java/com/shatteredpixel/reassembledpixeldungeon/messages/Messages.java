...
package com.shatteredpixel.reassembledpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredpixel.reassembledpixeldungeon.messages.actors.actors",
			"com.shatteredpixel.reassembledpixeldungeon.messages.items.items",
			"com.shatteredpixel.reassembledpixeldungeon.messages.levels.levels",
			"com.shatteredpixel.reassembledpixeldungeon.messages.plants.plants",
			"com.shatteredpixel.reassembledpixeldungeon.messages.scenes.scenes",
			"com.shatteredpixel.reassembledpixeldungeon.messages.ui.ui",
			"com.shatteredpixel.reassembledpixeldungeon.messages.windows.windows",
			"com.shatteredpixel.reassembledpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredpixel.reassembledpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
