...
package com.shatteredpixel.reassembledpixeldungeon.tiles;
...
public class DungeonTileSheet {
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.DOOR, Terrain.OPEN_DOOR, Terrain.LOCKED_DOOR, Terrain.BARS
	));
	...
	public static final int FLAT_RUBBLE			= FLAT_BARRICADE;
	...
	public static final int RAISED_BARS				= RAISED_OTHER+3;
	...
	public static final int BARS_OVERHANG				= WALL_OVERHANG+27;
	...
	static {
		...
		directFlatVisuals.put(Terrain.BARS,			FLAT_BARRICADE);
