...
package com.shatteredpixel.reassembledpixeldungeon.ui;
...
import com.shatteredpixel.reassembledpixeldungeon.windows.WndJournal;
...
public class StatusPane extends Component {
	...
	protected void createChildren() {
		...
		hunger = new Image( Assets.HUNGER_BAR );
		add( hunger );
	...
	public void update() {
		...
		hunger.scale.x = Math.max(0, (maxHg - hg)/maxHg);
